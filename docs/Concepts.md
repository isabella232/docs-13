...
[How to work with permanent auth tokens](/#permanent-auth-tokens)
...
!!! hint ""
    As an alternative, you can set up public access for create, read, update and delete operations ([see here](/#using-permissions)). This will allow you to skip the token step.
